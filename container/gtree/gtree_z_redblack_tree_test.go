...
func Test_RedBlackTree_Basic(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		m := NewRedBlackTree(gutil.ComparatorString)
		m.Set("key1", "val1")
		...
		m2 := NewRedBlackTreeFrom(gutil.ComparatorString, map[interface{}]interface{}{1: 1, "key1": "val1"})
...
func Test_RedBlackTree_Iterator(t *testing.T) {
	...
	m := NewRedBlackTreeFrom(gutil.ComparatorString, expect)
...
func Test_RedBlackTree_IteratorFrom(t *testing.T) {
	...
	tree := NewRedBlackTreeFrom(gutil.ComparatorInt, m)
...
func Test_RedBlackTree_Clone(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		//clone 方法是深克隆
		m := NewRedBlackTreeFrom(gutil.ComparatorString, map[interface{}]interface{}{1: 1, "key1": "val1"})
		m_clone := m.Clone()
		m.Remove(1)
...
func Test_RedBlackTree_LRNode(t *testing.T) {
	...
	//unsafe
	gtest.C(t, func(t *gtest.T) {
		m := NewRedBlackTreeFrom(gutil.ComparatorString, expect, true)
		t.Assert(m.Left().Key, "key1")
		t.Assert(m.Right().Key, "key4")
	})
}
...
func Test_RedBlackTree_CeilingFloor(t *testing.T) {
	...
	//found and eq
	gtest.C(t, func(t *gtest.T) {
		m := NewRedBlackTreeFrom(gutil.ComparatorInt, expect)
		c, cf := m.Ceiling(8)
		t.Assert(cf, true)
...
func Test_RedBlackTree_Remove(t *testing.T) {
	m := NewRedBlackTree(gutil.ComparatorInt)
	for i := 1; i <= 100; i++ {
