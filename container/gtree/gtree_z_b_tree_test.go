...
func Test_BTree_Basic(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		m := NewBTree(3, gutil.ComparatorString)
		m.Set("key1", "val1")
		...
		m2 := NewBTreeFrom(3, gutil.ComparatorString, map[interface{}]interface{}{1: 1, "key1": "val1"})
...
func Test_BTree_Iterator(t *testing.T) {
	...
	m := NewBTreeFrom(3, gutil.ComparatorString, expect)
...
func Test_BTree_IteratorFrom(t *testing.T) {
	...
	tree := NewBTreeFrom(3, gutil.ComparatorInt, m)
...
func Test_BTree_Clone(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		//clone 方法是深克隆
		m := NewBTreeFrom(3, gutil.ComparatorString, map[interface{}]interface{}{1: 1, "key1": "val1"})
		m_clone := m.Clone()
		m.Remove(1)
...
func Test_BTree_LRNode(t *testing.T) {
	...
	//unsafe
	gtest.C(t, func(t *gtest.T) {
		m := NewBTreeFrom(3, gutil.ComparatorString, expect, true)
		t.Assert(m.Left().Key, "key1")
		t.Assert(m.Right().Key, "key4")
	})
}
...
func Test_BTree_Remove(t *testing.T) {
	m := NewBTree(3, gutil.ComparatorInt)
	for i := 1; i <= 100; i++ {
