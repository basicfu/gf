...
func Test_AVLTree_Basic(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		m := NewAVLTree(gutil.ComparatorString)
		m.Set("key1", "val1")
		...
		m2 := NewAVLTreeFrom(gutil.ComparatorString, map[interface{}]interface{}{1: 1, "key1": "val1"})
...
func Test_AVLTree_Iterator(t *testing.T) {
	...
	m := NewAVLTreeFrom(gutil.ComparatorString, expect)
...
func Test_AVLTree_IteratorFrom(t *testing.T) {
	...
	tree := NewAVLTreeFrom(gutil.ComparatorInt, m)
...
func Test_AVLTree_Clone(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		//clone 方法是深克隆
		m := NewAVLTreeFrom(gutil.ComparatorString, map[interface{}]interface{}{1: 1, "key1": "val1"})
		m_clone := m.Clone()
		m.Remove(1)
...
func Test_AVLTree_LRNode(t *testing.T) {
	...
	//unsafe
	gtest.C(t, func(t *gtest.T) {
		m := NewAVLTreeFrom(gutil.ComparatorString, expect, true)
		t.Assert(m.Left().Key, "key1")
		t.Assert(m.Right().Key, "key4")
	})
}
...
func Test_AVLTree_CeilingFloor(t *testing.T) {
	...
	//found and eq
	gtest.C(t, func(t *gtest.T) {
		m := NewAVLTreeFrom(gutil.ComparatorInt, expect)
		c, cf := m.Ceiling(8)
		t.Assert(cf, true)
...
func Test_AVLTree_Remove(t *testing.T) {
	m := NewAVLTree(gutil.ComparatorInt)
	for i := 1; i <= 50; i++ {
