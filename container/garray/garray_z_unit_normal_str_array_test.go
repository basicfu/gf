...
func Test_StrArray_Basic(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		array := NewStrArrayFrom(expect)
		array2 := NewStrArrayFrom(expect, true)
		array3 := NewStrArrayFrom([]string{})
...
func TestStrArray_PopLeft(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		array := NewStrArrayFrom(g.SliceStr{"1", "2", "3"})
		v, ok := array.PopLeft()
		t.Assert(v, 1)
		t.Assert(ok, true)
...
func TestStrArray_PopLeftsAndPopRights(t *testing.T) {
	...
	gtest.C(t, func(t *gtest.T) {
		...
		array1 := NewStrArrayFrom(value1)
		array2 := NewStrArrayFrom(value2)
...
func TestString_Range(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		value1 := []string{"0", "1", "2", "3", "4", "5", "6"}
		array1 := NewStrArrayFrom(value1)
		array2 := NewStrArrayFrom(value1, true)
...
func TestStrArray_Merge(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		a11 := []string{"0", "1", "2", "3"}
		a21 := []string{"4", "5", "6", "7"}
		array1 := NewStrArrayFrom(a11)
		array2 := NewStrArrayFrom(a21)
...
func TestStrArray_Fill(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		a1 := []string{"0"}
		a2 := []string{"0"}
		array1 := NewStrArrayFrom(a1)
		array2 := NewStrArrayFrom(a2)
...
func TestStrArray_SubSlice(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		array1 := NewStrArrayFrom(a1)
		array2 := NewStrArrayFrom(a1, true)
...
func TestNewStrArrayFromCopy(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		a1 := []string{"0", "1", "2", "3", "4", "5", "6"}
		a2 := NewStrArrayFromCopy(a1)
		a3 := NewStrArrayFromCopy(a1, true)
...
func TestStrArray_FilterEmpty(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		array := NewStrArrayFrom(g.SliceStr{"", "1", "2", "0"})
		t.Assert(array.FilterEmpty(), g.SliceStr{"1", "2", "0"})
	})
	gtest.C(t, func(t *gtest.T) {
		array := NewStrArrayFrom(g.SliceStr{"1", "2"})
