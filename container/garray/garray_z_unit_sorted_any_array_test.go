...
func TestSortedArray_PopLeft(t *testing.T) {
	...
	gtest.C(t, func(t *gtest.T) {
		array := NewSortedArrayFrom(g.Slice{1, 2, 3}, gutil.ComparatorInt)
		v, ok := array.PopLeft()
		t.Assert(v, 1)
		t.Assert(ok, true)
...
func TestSortedArray_Empty(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		array := NewSortedArray(gutil.ComparatorInt)
		v, ok := array.PopLeft()
		t.Assert(v, nil)
		t.Assert(ok, false)
...
func TestSortedArray_Chunk(t *testing.T) {
	...
	gtest.C(t, func(t *gtest.T) {
		...
		array1 := NewSortedArrayFrom(a1, gutil.ComparatorInt)
...
func TestSortedArray_Join(t *testing.T) {
	...
	gtest.C(t, func(t *gtest.T) {
		...
		array1 := NewSortedArrayFrom(a1, gutil.ComparatorString)
...
func TestSortedArray_Merge(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		s1 := []interface{}{"a", "b", "c", "d"}
		s2 := []string{"e", "f"}
		i1 := NewIntArrayFrom([]int{1, 2, 3})
		i2 := NewArrayFrom([]interface{}{3})
		s3 := NewStrArrayFrom([]string{"g", "h"})
		s4 := NewSortedArrayFrom([]interface{}{4, 5}, func1)
		s5 := NewSortedStrArrayFrom(s2)
		s6 := NewSortedIntArrayFrom([]int{1, 2, 3})

		a1 := NewSortedArrayFrom(s1, func1)
...
func TestSortedArray_Json(t *testing.T) {
	...
	gtest.C(t, func(t *gtest.T) {
		...
		a1 := NewSortedArrayFrom(s1, gutil.ComparatorString)
		b1, err1 := json.Marshal(a1)
		b2, err2 := json.Marshal(s1)
		t.Assert(b1, b2)
		t.Assert(err1, err2)

		a2 := NewSortedArray(gutil.ComparatorString)
...
func TestSortedArray_Iterator(t *testing.T) {
	...
	array := NewSortedArrayFrom(slice, gutil.ComparatorString)
	gtest.C(t, func(t *gtest.T) {
...
func TestSortedArray_FilterNil(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		array := NewSortedArrayFromCopy(values, gutil.ComparatorInt)
		t.Assert(array.FilterNil().Slice(), g.Slice{0, "", g.Slice{}, 1, 2, 3, 4})
	})
	gtest.C(t, func(t *gtest.T) {
		array := NewSortedArrayFromCopy(g.Slice{nil, 1, 2, 3, 4, nil}, gutil.ComparatorInt)
...
func TestSortedArray_FilterEmpty(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		array := NewSortedArrayFrom(g.Slice{0, 1, 2, 3, 4, "", g.Slice{}}, gutil.ComparatorInt)
		t.Assert(array.FilterEmpty(), g.Slice{1, 2, 3, 4})
	})
	gtest.C(t, func(t *gtest.T) {
		array := NewSortedArrayFrom(g.Slice{1, 2, 3, 4}, gutil.ComparatorInt)
		t.Assert(array.FilterEmpty(), g.Slice{1, 2, 3, 4})
	})
}
...
func TestSortedArray_Walk(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		array := NewSortedArrayFrom(g.Slice{"1", "2"}, gutil.ComparatorString)
