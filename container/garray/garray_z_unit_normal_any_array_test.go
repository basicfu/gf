...
func Test_Array_Basic(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		array2 := NewArrayFrom(expect)
		array3 := NewArrayFrom([]interface{}{})
...
func TestArray_Merge(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		array1 := NewArrayFrom(i1)
		array2 := NewArrayFrom(i2)
		t.Assert(array1.Merge(array2).Slice(), []interface{}{0, 1, 2, 3, 4, 5, 6, 7})

		//s1 := []string{"a", "b", "c", "d"}
		s2 := []string{"e", "f"}
		i3 := NewIntArrayFrom([]int{1, 2, 3})
		i4 := NewArrayFrom([]interface{}{3})
...
func TestArray_FilterNil(t *testing.T) {
	...
	gtest.C(t, func(t *gtest.T) {
		array := NewArrayFromCopy(g.Slice{nil, 1, 2, 3, 4, nil})
...
func TestArray_FilterEmpty(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		array := NewArrayFrom(g.Slice{0, 1, 2, 3, 4, "", g.Slice{}})
		t.Assert(array.FilterEmpty(), g.Slice{1, 2, 3, 4})
	})
	gtest.C(t, func(t *gtest.T) {
		array := NewArrayFrom(g.Slice{1, 2, 3, 4})
		t.Assert(array.FilterEmpty(), g.Slice{1, 2, 3, 4})
	})
}
...
func TestArray_Walk(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		array := NewArrayFrom(g.Slice{"1", "2"})
