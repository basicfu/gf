...
func Test_IntArray_Basic(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		expect := []int{0, 1, 2, 3}
		expect2 := []int{}
		array := NewIntArrayFrom(expect)
		array2 := NewIntArrayFrom(expect2)
...
func TestIntArray_PopLeftsAndPopRights(t *testing.T) {
	...
	gtest.C(t, func(t *gtest.T) {
		...
		array1 := NewIntArrayFrom(value1)
		array2 := NewIntArrayFrom(value2)
...
func TestIntArray_Range(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		value1 := []int{0, 1, 2, 3, 4, 5, 6}
		array1 := NewIntArrayFrom(value1)
		array2 := NewIntArrayFrom(value1, true)
...
func TestIntArray_Merge(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		s1 := []string{"a", "b", "c"}
		s2 := []string{"e", "f"}
		a1 := NewIntArrayFrom(n1)
		a2 := NewIntArrayFrom(n2)
		a3 := NewArrayFrom(i1)
		a4 := NewStrArrayFrom(s1)

		a5 := NewSortedStrArrayFrom(s2)
		a6 := NewSortedIntArrayFrom([]int{1, 2, 3})

		a7 := NewSortedStrArrayFrom(s1)
		a8 := NewSortedArrayFrom([]interface{}{4, 5}, func1)
...
func TestIntArray_Fill(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		a1 := []int{0}
		a2 := []int{0}
		array1 := NewIntArrayFrom(a1)
		array2 := NewIntArrayFrom(a2)
...
func TestIntArray_PopLeft(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		array := NewIntArrayFrom(g.SliceInt{1, 2, 3})
		v, ok := array.PopLeft()
		t.Assert(v, 1)
		t.Assert(ok, true)
...
func TestIntArray_SubSlice(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		array1 := NewIntArrayFrom(a1)
		array2 := NewIntArrayFrom(a1, true)
...
func TestIntArray_FilterEmpty(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		array := NewIntArrayFrom(g.SliceInt{0, 1, 2, 3, 4, 0})
		t.Assert(array.FilterEmpty(), g.SliceInt{1, 2, 3, 4})
	})
	gtest.C(t, func(t *gtest.T) {
		array := NewIntArrayFrom(g.SliceInt{1, 2, 3, 4})
		t.Assert(array.FilterEmpty(), g.SliceInt{1, 2, 3, 4})
	})
}
...
func TestIntArray_Walk(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		array := NewIntArrayFrom(g.SliceInt{1, 2})
