...
func TestVar_ListItemValues_Map(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		t.Assert(New(listMap).ListItemValues("id"), g.Slice{1, 2, 3})
		t.Assert(New(listMap).ListItemValues("score"), g.Slice{100, 99, 99})
	})
	gtest.C(t, func(t *gtest.T) {
		listMap := g.List{
			g.Map{"id": 1, "score": 100},
		...
		t.Assert(New(listMap).ListItemValues("id"), g.Slice{1, 2, 3})
		t.Assert(New(listMap).ListItemValues("score"), g.Slice{100, nil, 0})
	})
}
...
func TestVar_ListItemValuesUnique(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		t.Assert(New(listMap).ListItemValuesUnique("id"), g.Slice{1, 2, 3, 4, 5})
		t.Assert(New(listMap).ListItemValuesUnique("score"), g.Slice{100})
	})
	gtest.C(t, func(t *gtest.T) {
		listMap := g.List{
			g.Map{"id": 1, "score": 100},
		...
		t.Assert(New(listMap).ListItemValuesUnique("id"), g.Slice{1, 2, 3, 4, 5})
		t.Assert(New(listMap).ListItemValuesUnique("score"), g.Slice{100, 99})
	})
	gtest.C(t, func(t *gtest.T) {
		listMap := g.List{
			g.Map{"id": 1, "score": 100},
		...
		t.Assert(New(listMap).ListItemValuesUnique("id"), g.Slice{1, 2, 3, 4, 5})
		t.Assert(New(listMap).ListItemValuesUnique("score"), g.Slice{100, 0, 99})
	})
}
