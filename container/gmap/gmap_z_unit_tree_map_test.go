...
func Test_TreeMap_Basic(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		m := NewTreeMap(gutil.ComparatorString)
		m.Set("key1", "val1")
		t.Assert(m.Keys(), []interface{}{"key1"})
		...
		m2 := NewTreeMapFrom(gutil.ComparatorString, map[interface{}]interface{}{1: 1, "key1": "val1"})
...
func Test_TreeMap_Iterator(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		m := NewTreeMapFrom(gutil.ComparatorString, expect)
...
func Test_TreeMap_Clone(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		//clone 方法是深克隆
		m := NewTreeMapFrom(gutil.ComparatorString, map[interface{}]interface{}{1: 1, "key1": "val1"})
		m_clone := m.Clone()
		m.Remove(1)
...
func Test_TreeMap_Json(t *testing.T) {
	...
	gtest.C(t, func(t *gtest.T) {
		...
		m1 := NewTreeMapFrom(gutil.ComparatorString, data)
