...
func Test_IntStrMap_Basic(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		m2 := NewIntStrMapFrom(map[int]string{1: "a", 2: "b"})
...
func Test_IntStrMap_Clone(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		//clone 方法是深克隆
		m := NewIntStrMapFrom(map[int]string{1: "a", 2: "b", 3: "c"})
...
func Test_IntStrMap_Pop(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		m := NewIntStrMapFrom(g.MapIntStr{
			1: "v1",
			2: "v2",
		})
		t.Assert(m.Size(), 2)
