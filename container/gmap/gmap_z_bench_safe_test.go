...
var anyAnyMap = NewAnyAnyMap(true)
var intIntMap = NewIntIntMap(true)
var intAnyMap = NewIntAnyMap(true)
var intStrMap = NewIntStrMap(true)
var strIntMap = NewStrIntMap(true)
var strAnyMap = NewStrAnyMap(true)
var strStrMap = NewStrStrMap(true)
