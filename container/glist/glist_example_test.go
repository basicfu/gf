...
func ExampleList_RLockFunc() {
	...
	l := NewFrom(garray.NewArrayRange(1, 10, 1).Slice(), true)
...
func ExampleList_IteratorAsc() {
	...
	l.IteratorAsc(func(e *Element) bool {
		fmt.Print(e.Value)
		return true
	})
...
func ExampleList_IteratorDesc() {
	...
	l.IteratorDesc(func(e *Element) bool {
		fmt.Print(e.Value)
		return true
	})
	// Output:
...
func ExampleList_PopBack() {
	l := NewFrom(g.Slice{1, 2, 3, 4, 5, 6, 7, 8, 9})
