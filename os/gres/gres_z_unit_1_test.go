...
func Test_PackToGoFile(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		pkgName := "testdata"
		err := PackToGoFile(srcPath, goFilePath, pkgName)
		t.Assert(err, nil)
	})
}
...
func Test_PackToFile(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		err := PackToFile(srcPath, dstPath)
		t.Assert(err, nil)
...
func Test_PackMulti(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		t.Assert(err, nil)
		err = PackToGoFile(strings.Join(array, ","), goFilePath, pkgName)
		t.Assert(err, nil)
	})
}
...
func Test_PackWithPrefix1(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		pkgName := "testdata"
		err := PackToGoFile(srcPath, goFilePath, pkgName, "www/gf-site/test")
		t.Assert(err, nil)
	})
}
...
func Test_PackWithPrefix2(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		goFilePath := gfile.TempDir("testdata.go")
		pkgName := "testdata"
		err := PackToGoFile(srcPath, goFilePath, pkgName, "/var/www/gf-site/test")
		t.Assert(err, nil)
	})
}
