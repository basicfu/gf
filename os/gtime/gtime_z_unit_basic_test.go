...
func Test_SetTimeZone(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		t.Assert(SetTimeZone("Asia/Shanghai"), nil)
...
func Test_Date(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		t.Assert(Date(), time.Now().Format("2006-01-02"))
	})
}
...
func Test_Datetime(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		datetime := Datetime()
		timeTemp, err := StrToTime(datetime, "Y-m-d H:i:s")
		if err != nil {
			t.Error("test fail")
		}
...
func Test_StrToTime(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		for index, item := range testDateFormats {
			timeTemp, err := StrToTime(testDateFormatsResult[index], item)
			if err != nil {
				t.Error("test fail")
			}
		...
		//test err
		_, err := StrToTime("2006-01-02 15:04:05", "aabbccdd")
		if err == nil {
			t.Error("test fail")
		}
	})
...
func Test_ConvertZone(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		//转换为洛杉矶时间
		t1, err := ConvertZone(nowUTC.Format("2006-01-02 15:04:05"), testZone, "")
		if err != nil {
			t.Error("test fail")
		}
	...
	gtest.C(t, func(t *gtest.T) {
		...
		//错误时间输入
		_, err := ConvertZone(nowUTC.Format("06..02 15:04:05"), testZone, "")
		if err == nil {
			t.Error("test fail")
		}
		//错误时区输入
		_, err = ConvertZone(nowUTC.Format("2006-01-02 15:04:05"), testZone, "")
		if err == nil {
			t.Error("test fail")
		}
		//错误时区输入
		_, err = ConvertZone(nowUTC.Format("2006-01-02 15:04:05"), testZone, testZone)
		if err == nil {
			t.Error("test fail")
		}
	})
...
func Test_ParseTimeFromContent(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		timeTemp := ParseTimeFromContent("我是中文2006-01-02 15:04:05我也是中文", "Y-m-d H:i:s")
		t.Assert(timeTemp.Time.Format("2006-01-02 15:04:05"), "2006-01-02 15:04:05")

		timeTemp1 := ParseTimeFromContent("我是中文2006-01-02 15:04:05我也是中文")
		t.Assert(timeTemp1.Time.Format("2006-01-02 15:04:05"), "2006-01-02 15:04:05")

		timeTemp2 := ParseTimeFromContent("我是中文02.jan.2006 15:04:05我也是中文")
		t.Assert(timeTemp2.Time.Format("2006-01-02 15:04:05"), "2006-01-02 15:04:05")

		//test err
		timeTempErr := ParseTimeFromContent("我是中文", "Y-m-d H:i:s")
		if timeTempErr != nil {
			t.Error("test fail")
		}
	})
