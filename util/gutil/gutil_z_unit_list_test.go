...
func Test_ListItemValues_Map(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		t.Assert(ListItemValues(listMap, "id"), g.Slice{1, 2, 3})
		t.Assert(ListItemValues(listMap, "score"), g.Slice{100, 99, 99})
	})
	gtest.C(t, func(t *gtest.T) {
		listMap := g.List{
			g.Map{"id": 1, "score": 100},
		...
		t.Assert(ListItemValues(listMap, "id"), g.Slice{1, 2, 3})
		t.Assert(ListItemValues(listMap, "score"), g.Slice{100, nil, 0})
	})
}
...
func Test_ListItemValues_Map_SubKey(t *testing.T) {
	...
	gtest.C(t, func(t *gtest.T) {
		...
		t.Assert(ListItemValues(listMap, "scores", "Math"), g.Slice{100, 0, 59})
		t.Assert(ListItemValues(listMap, "scores", "English"), g.Slice{60, 100, 99})
		t.Assert(ListItemValues(listMap, "scores", "PE"), g.Slice{})
	})
}
...
func Test_ListItemValues_Map_Array_SubKey(t *testing.T) {
	...
	gtest.C(t, func(t *gtest.T) {
		...
		t.Assert(ListItemValues(listMap, "scores", "Math"), g.Slice{1, 3, 5, 7, 9, 11})
		t.Assert(ListItemValues(listMap, "scores", "English"), g.Slice{2, 4, 6, 8, 10, 12})
		t.Assert(ListItemValues(listMap, "scores", "PE"), g.Slice{})
	})
}
...
func Test_ListItemValuesUnique(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		t.Assert(ListItemValuesUnique(listMap, "id"), g.Slice{1, 2, 3, 4, 5})
		t.Assert(ListItemValuesUnique(listMap, "score"), g.Slice{100})
	})
	gtest.C(t, func(t *gtest.T) {
		listMap := g.List{
			g.Map{"id": 1, "score": 100},
		...
		t.Assert(ListItemValuesUnique(listMap, "id"), g.Slice{1, 2, 3, 4, 5})
		t.Assert(ListItemValuesUnique(listMap, "score"), g.Slice{100, 99})
	})
	gtest.C(t, func(t *gtest.T) {
		listMap := g.List{
			g.Map{"id": 1, "score": 100},
		...
		t.Assert(ListItemValuesUnique(listMap, "id"), g.Slice{1, 2, 3, 4, 5})
		t.Assert(ListItemValuesUnique(listMap, "score"), g.Slice{100, 0, 99})
	})
}
...
func Test_ListItemValuesUnique_Map_Array_SubKey(t *testing.T) {
	...
	gtest.C(t, func(t *gtest.T) {
		...
		t.Assert(ListItemValuesUnique(listMap, "scores", "Math"), g.Slice{1, 5, 9, 11})
		t.Assert(ListItemValuesUnique(listMap, "scores", "English"), g.Slice{2, 8, 10, 12})
		t.Assert(ListItemValuesUnique(listMap, "scores", "PE"), g.Slice{})
	})
}
