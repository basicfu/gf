...
func Test_Basic(t *testing.T) {
	...
	gtest.C(t, func(t *gtest.T) {
		page := New(9, 2, 3, `/user/list?page={.page}`)
	...
	gtest.C(t, func(t *gtest.T) {
		page := New(9, 2, 5, `/user/list?page={.page}`)
