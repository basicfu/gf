...
func Test_Check(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		val2 := 7
		val3 := 20
		err1 := Check(val1, rule, nil)
		err2 := Check(val2, rule, nil)
		err3 := Check(val3, rule, nil)
...
func Test_RequiredIf(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		t.AssertNE(Check("", rule, nil, g.Map{"id": 1}), nil)
		t.Assert(Check("", rule, nil, g.Map{"id": 0}), nil)
		t.AssertNE(Check("", rule, nil, g.Map{"age": 18}), nil)
		t.Assert(Check("", rule, nil, g.Map{"age": 20}), nil)
	})
}
...
func Test_RequiredUnless(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		t.Assert(Check("", rule, nil, g.Map{"id": 1}), nil)
		t.AssertNE(Check("", rule, nil, g.Map{"id": 0}), nil)
		t.Assert(Check("", rule, nil, g.Map{"age": 18}), nil)
		t.AssertNE(Check("", rule, nil, g.Map{"age": 20}), nil)
	})
}
...
func Test_RequiredWith(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		err1 := Check(val1, rule, nil, params1)
		err2 := Check(val1, rule, nil, params2)
		err3 := Check(val1, rule, nil, params3)
		t.Assert(err1, nil)
		t.AssertNE(err2, nil)
		t.AssertNE(err3, nil)
	})
...
func Test_Date(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		err2 := Check(val2, rule, nil)
		err3 := Check(val3, rule, nil)
		err4 := Check(val4, rule, nil)
		err5 := Check(val5, rule, nil)
		err6 := Check(val6, rule, nil)
		err7 := Check(val7, rule, nil)
		t.Assert(err1, nil)
		t.Assert(err2, nil)
		t.Assert(err3, nil)
		t.Assert(err4, nil)
...
func Test_DateFormat(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		val5 := "2010~11~01"
		val6 := "2010-11~01"
		err1 := Check(val1, "date-format:Y", nil)
		err2 := Check(val2, "date-format:Ym", nil)
		err3 := Check(val3, "date-format:Y.m", nil)
		err4 := Check(val4, "date-format:Ym-d", nil)
		err5 := Check(val5, "date-format:Y~m~d", nil)
		err6 := Check(val6, "date-format:Y~m~d", nil)
		t.Assert(err1, nil)
		t.Assert(err2, nil)
		t.Assert(err3, nil)
		t.Assert(err4, nil)
...
func Test_Email(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		err1 := Check(value1, rule, nil)
		err2 := Check(value2, rule, nil)
		err3 := Check(value3, rule, nil)
		err4 := Check(value4, rule, nil)
		t.AssertNE(err1, nil)
		t.AssertNE(err2, nil)
		t.Assert(err3, nil)
		t.Assert(err4, nil)
...
func Test_PhoneLoose(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		err1 := Check("13333333333", "phone-loose", nil)
		err2 := Check("15555555555", "phone-loose", nil)
		err3 := Check("16666666666", "phone-loose", nil)
		err4 := Check("23333333333", "phone-loose", nil)
		err5 := Check("1333333333", "phone-loose", nil)
		err6 := Check("10333333333", "phone-loose", nil)
		t.Assert(err1, nil)
		t.Assert(err2, nil)
		t.Assert(err3, nil)
		t.AssertNE(err4, nil)
...
func Test_Ip(t *testing.T) {
	if m := Check("10.0.0.1", "ip", nil); m != nil {
		t.Error(m)
	}
	...
	if m := Check("1920.0.0.0", "ip", nil); m == nil {
		t.Error("ipv4校验失败")
	}
	...
	if m := Check("fe80::5484:7aff:fefe:9799", "ip", nil); m != nil {
		t.Error(m)
	}
	if m := Check("fe80::5484:7aff:fefe:9799123", "ip", nil); m == nil {
		t.Error(m)
	}
}
...
func Test_MinLength(t *testing.T) {
	...
	if m := Check("12345", rule, msgs); m == nil {
		t.Error("长度校验失败")
	}

	rule2 := "min-length:abc"
	if m := Check("123456", rule2, nil); m == nil {
		t.Error("长度校验失败")
	}
}
...
func Test_MaxLength(t *testing.T) {
	...
	if m := Check("1234567", rule, msgs); m == nil {
		t.Error("长度校验失败")
	}
...
func Test_Regex2(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		err1 := Check(str1, rule, nil)
		err2 := Check(str2, rule, nil)
		err3 := Check(str3, rule, nil)
		t.AssertNE(err1, nil)
		t.AssertNE(err2, nil)
		t.Assert(err3, nil)
...
// issue: https://github.com/basicfu/gf/issues/1077
